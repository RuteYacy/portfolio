  ...
  return <section className='min-h-[100vh] flex items-center' id='home'>
    <div className='container mx-auto'>
      <div className='flex-1 text-center lg:text-left'>
        ...
        className='font-montserrat text-[48px] font-bold leading-[0.8] lg:text-[80px] pt-10'>
          RUTE SOUZA
        </motion.h1>
        ...
        className='mb-6 mt-[2%] text-[32px] lg:text-[50px] font-montserrat font-semibold leading-[1]'>
          ...
          <TypeAnimation sequence={[' FRONT-END DEVELOPER']} 
        ...
        className='mb-8 max-w-[600px] mx-auto text-[20px] lg:text-[22px] tracking-wide lg:mx-0 font-montserrat'>
