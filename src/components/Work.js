...
const Work = () => {
  ...
  return (
    <section className='section' id='work'>
      <div className='container mx-auto pt-14 w-[1050px]'>
        ...
        <div className='flex flex-col lg:flex-row gap-x-4 xl:gap-x-6'>
          ...
          {/* 1st column images */}
            ...
            className='group relative overflow-hidden border-2 border-white/50 rounded-lg'>
              {/* overlay */}
              ...
              <div className='absolute -bottom-full left-12 group-hover:bottom-9 transition-all duration-700 z-50'>
                <a href='https://ruteyacy.github.io/store/'
                ...
                {lyriks && <a href='https://ruteyacy.github.io/store/'
            ...
            className='group relative overflow-hidden border-2 border-white/50 rounded-lg'>
              ...
              {/* button */}
              <div className='absolute -bottom-full left-12 group-hover:bottom-9 transition-all duration-700 z-50'>
                <a href='https://ruteyacy.github.io/restaurant/'
                className='hidden xxl:inline font-montserrat border border-white p-2 w-36 hover:bg-white hover:text-purple-900'>View Site</a>
                {restaurant && <a href='https://ruteyacy.github.io/restaurant/'
                className='xxl:hidden font-montserrat border border-white p-2 w-36 hover:bg-white hover:text-purple-900'>View Site</a>}
              </div>
            </div>
          </motion.div>
          ...
          className='flex-1 flex flex-col gap-y-6'>
            ...
            className='group relative overflow-hidden border-2 border-white/50 rounded-lg'>
              ...
              {/* button */}
              <div className='absolute -bottom-full left-12 group-hover:bottom-9 transition-all duration-700 z-50'>
                <a href='https://ruteyacy.github.io/travel-site/'
                className='hidden xxl:inline font-montserrat border border-white p-2 w-36 hover:bg-white hover:text-purple-900'>View Site</a>
                {travel && <a href='https://ruteyacy.github.io/travel-site/'
                className='xxl:hidden font-montserrat border border-white p-2 w-36 hover:bg-white hover:text-purple-900'>View Site</a>}
              </div>
            </div>
            {/* image */}
            ...
            className='group relative overflow-hidden border-2 border-white/50 rounded-lg'>
              ...
              {/* button */}
              <div className='absolute -bottom-full left-12 group-hover:bottom-9 transition-all duration-700 z-50'>
                <a href='https://ruteyacy.github.io/renting/'
                className='hidden xxl:inline font-montserrat border border-white p-2 w-36 hover:bg-white hover:text-purple-900'>View Site</a>
                {housing && <a href='https://ruteyacy.github.io/renting/'
                className='xxl:hidden font-montserrat border border-white p-2 w-36 hover:bg-white hover:text-purple-900'>View Site</a>}
              </div>
            </div>
          </motion.div>
